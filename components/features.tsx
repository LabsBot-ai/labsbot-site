        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="flex justify-center pb-8 md:pb-12" data-aos="fade-up">
            <div className="relative flex min-h-[10rem] w-full max-w-[320px] items-center justify-center py-2 sm:min-h-[11rem]">
              <div
                className="pointer-events-none absolute inset-0 -m-2 rounded-full bg-gradient-to-br from-indigo-500/30 via-violet-500/20 to-indigo-600/25 blur-3xl opacity-60 animate-pulse"
                aria-hidden
              />
              <div className="relative flex items-center justify-center text-indigo-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 1024 1024"
                  className="relative z-10 h-28 w-auto max-w-[240px] object-contain drop-shadow-[0_0_25px_rgba(99,102,241,0.6),0_0_60px_rgba(139,92,246,0.4)] sm:h-32 md:h-36 md:max-w-[280px]"
                  aria-hidden
                >
