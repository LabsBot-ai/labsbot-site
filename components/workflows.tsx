          ...
          >
            ...
            <div className={productCardClass}>
              <div className={cardInnerClass}>
                ...
                >
                  <div
                    className="pointer-events-none absolute top-[8%] right-[-22%] h-[138%] w-[min(175%,46rem)] max-w-none origin-top-right -rotate-[12deg] bg-no-repeat opacity-[0.09] blur-[0.5px] mix-blend-soft-light select-none"
                    style={{
