export const metadata = {
  title: "LingvaBot - LabsBot",
  description:
    "LingvaBot — a service for simple language explanation and making language easier to understand.",
};
...
export default function LingvaBotProductPage() {
  return (
    <>
