        ...
        <div className="py-12 md:py-20">
          ...
          <form className="mx-auto max-w-[400px]">
            ...
            <div className="mt-6 space-y-5">
              <button className="btn w-full bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-600 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_--theme(--color-white/.16)] hover:bg-[length:100%_150%] transition-all">
                Register
              </button>
